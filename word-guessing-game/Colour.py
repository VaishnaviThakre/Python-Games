...
COLOUR_WORD = ['LUBE', 'OELYWL', 'IHWET', 'CKALB', 'ERGEN', 'LTEIOV', 'ETMAGAN', 'GDINIO']

COLOUR_ANSWER = ['BLUE', 'YELLOW','WHITE', 'BLACK', 'GREEN', 'VIOLET', 'MAGENTA', 'INDIGO']
...
def main():
    ...
    my_window.title("Guess These Colors Jumbled Words")
