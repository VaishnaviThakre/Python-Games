...
SHAPES_WORD = ['RCCEIL', 'MDNDOIA', 'RNGETILA', 'QREUSA', 'GREATLENC', 'GNPTAEON']

SHAPES_ANSWER = ['CIRCLE', 'DIAMOND', 'TRIANGLE', 'SQUARE', 'RECTANGLE', 'PENTAGON']
...
def main():
    ...
    my_window.title("Guess These Shapes Jumbled Words")
