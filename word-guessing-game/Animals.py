...
ANIMALS_WORD = ['CAEKOPC', 'ERITG', 'ATC', 'KSEAN', 'RHOES', 'ENLHATPE', 'RORATP', 'LDIOCERCO', 'LOW']

ANIMALS_ANSWER = ['PEACOCK', 'TIGER', 'CAT', 'SNAKE', 'HORSE', 'ELEPHANT', 'PARROT', 'CROCODILE', 'OWL']
...
def main():
    ...
    my_window.title("Guess These Animals Jumbled Words")
    my_window.configure(background="")
