...
FRUITS_WORD = ['NGMAO', 'EGNRAO', 'RRYCHE', 'ESPARG', 'LPAEP', 'RBREUEBYL', 'IWIK']

FRUITS_ANSWER = ['MANGO', 'ORANGE', 'CHERRY',  'GRAPES', 'APPLE', 'BLUEBERRY', 'KIWI']
...
def main():
    ...
    my_window.title("Guess These Fruits Jumbled Words")
